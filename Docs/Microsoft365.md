...
Microsoft 365 or Office 365 is a collection of applications and cloud services, some of which are only available through a premium subscription.

The applications and services made available through a subscription allow you to collaborate, and share your best work.

The following table is a summary of some applications and services available.<br/>**Note:** Does not include all cloud services.


| Apps or Service | Description | 
| :---: | --- |
| Access<br/>![Logo](https://www.rramoscabral.com/training/assets/logos/MSAccess.png) | Is a database management system (DBMS) with a graphical user interface. Allows you to create your own database applications from templates or from scratch.<br/>**Only available on PC**<br/>Find more [here](https://www.microsoft.com/en-us/microsoft-365/access) |
| Advanced Threat Analytics<br/>![Logo](https://www.rramoscabral.com/training/assets/logos/MSAdvancedThreatAnalytics.png)  | Advanced Threat Analytics (ATA) is an on-premises platform that helps protect your enterprise from multiple types of advanced targeted cyber attacks and insider threats. Detect on-premises, advanced attacks in real time, leveraging unique approaches to Network Traffic Analytics & User and Entity Behavior Analytics. Review alerts and user activities to understand the attack methods and potential damage. Assess your security posture through full visibility into on-premises Active Directory configuration, users, and service accounts that could become compromised due to security misconfigurations or failure to follow best practices. <br/>Find more [here](https://go.microsoft.com/fwlink/p/?LinkID=2138124) |
| Bookings<br/>![Logo Bookings](https://www.rramoscabral.com/training/assets/logos/MSBookings.png) | Has flexibility and customization options to organize schedules and manage appointments. You can create and manage multiple Bookings calendars, each with their own unique setup. Different calendars can have different page structures, information, staff, and types of appointments and communication.<br/>Find more [here](https://www.microsoft.com/en-us/microsoft-365/business/scheduling-and-booking-app) |
| Cloud App Security<br/>![Logo](https://www.rramoscabral.com/training/assets/logos/MSCloudAppSecurity.png)  |  Microsoft Defender for Cloud Apps formerly known as Cloud App Security. Microsoft Defender for Cloud Apps is a Cloud Access Security Broker (CASB) that supports various deployment modes including log collection, API connectors, and reverse proxy. It provides rich visibility, control over data travel, and sophisticated analytics to identify and combat cyberthreats across all your Microsoft and third-party cloud services.<br/>Find more [here](https://www.microsoft.com/en-us/security/business/cloud-app-security) |
| Defender (Microsoft 365 Defender)<br/>![Logo](https://www.rramoscabral.com/training/assets/logos/MSDefender.png)  | Does not replace the antivirus installed on the machine. Microsoft 365 Defender is a unified pre- and post-breach enterprise defense suite that natively coordinates detection, prevention, investigation, and response across endpoints, identities, email, and applications to provide integrated protection against sophisticated attacks. <br/>Find more [here](https://docs.microsoft.com/en-us/microsoft-365/security/defender/microsoft-365-defender) |
| Defender for Endpoint (Microsoft Defender for Endpoint)<br/>![Logo](https://www.rramoscabral.com/training/assets/logos/MSDefenderForEndpoint.png) | Microsoft Defender for Endpoint delivers industry-leading endpoint security for Windows, macOS, Linux, Android, iOS, and network devices and helps to rapidly stop attacks, scale your security resources, and evolve your defenses. It’s delivered at cloud scale, with built-in AI that reasons over the industry’s broadest threat intelligence.<br/>Find more [here](https://www.microsoft.com/en-ww/security/business/threat-protection/endpoint-defender) |
| Defender for Identity (Microsoft Defender for Identity)<br/>![Logo](https://www.rramoscabral.com/training/assets/logos/MSDefenderForEndpoint.png)| Microsoft Defender for Identity (formerly Azure Advanced Threat Protection, also known as Azure ATP) is a cloud-based security solution that leverages your on-premises Active Directory signals to identify, detect, and investigate advanced threats, compromised identities, and malicious insider actions directed at your organization. Integrated threat protection with SIEM & XDR.<br/>Find more [here](https://www.microsoft.com/en-ww/security/business/threat-protection/identity-defender) |
| Defender for Office 365 (Microsoft Defender for Office 365)<br/> ![Logo](https://www.rramoscabral.com/training/assets/logos/MSDefender365.png)  | Microsoft 365 Defender is a unified pre and post-breach enterprise defense suite that natively coordinates detection, prevention, investigation, and response across endpoints, identities, email, and applications to provide integrated protection against sophisticated attacks. <br/>Find more [here](https://www.microsoft.com/en-ww/security/business/threat-protection/office-365-defender) |
| Edge<br/>![Logo](https://www.rramoscabral.com/training/assets/logos/MSEdge.png) | Microsoft Edge (Chromium-based) is an Internet browser that replaces Microsoft Edge Legacy (EdgeHTML-based) and Microsoft Internet Explorer. Microsoft Edge is not the only browser based in Chromium, other browsers like Google Chrome, Samsung Internet and Opera also use it.<br/>Find more [here](https://go.microsoft.com/fwlink/p/?LinkID=2115812) |
...
| Planner<br/>![Logo](https://www.rramoscabral.com/training/assets/logos/MSPlanner.png) | Microsoft Planner is a Kanban solution that simplifies task management and to-do lists for teams and is connected across Microsoft 365 apps.<br/>Find more [here](https://www.microsoft.com/en-ww/microsoft-365/business/task-management-software) |
...
| SharePoint<br/>![Logo](https://www.rramoscabral.com/training/assets/logos/MSSharePoint.png) | Share, organize, and discover information with Microsoft SharePoint. Learn about SharePoint Online, OneDrive for Business, and Apps for SharePoint<br/>Find more [here](https://www.microsoft.com/en-ww/microsoft-365/sharepoint/collaboration) |
